        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO ClassesTaught VALUES (?, ?, ?, ?, ?)"); //" ?, ?, ?)");
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE ClassesTaught SET QUARTER = ?, YEAR = ?, NAME = ?, COURSEID = ? "
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM ClassesTaught WHERE NAME = ? AND COURSEID = ? AND SECTIONID = ?");
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="ClassesTaught.jsp" method="get">

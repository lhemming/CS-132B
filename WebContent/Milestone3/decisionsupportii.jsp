...
<body>
        ...
        <tr>
            ...
            <%
                ...
                if (action != null && action.equals("submit")) {
                    ...
                    //error here rn
                    PreparedStatement pstmt = conn.prepareStatement("SELECT  count(letter_grade) AS COUNT, letter_grade FROM class, pastclasses, grade_conversion g, section WHERE class.classid = ? AND section.instructor = ? AND class.quarter = ? AND class.year = ? AND section.classid = class.classid AND class.classid = pastclasses.courseid AND pastclasses.grade = g.letter_grade AND pastclasses.sectionid = section.sectionid AND pastclasses.quarter = class.quarter AND pastclasses.year = class.year GROUP BY letter_grade ORDER BY letter_grade");
                    ...
                    <tr>
                        <th>Displaying Report For Course: <%=request.getParameter("CLASSID")%> 
                            ...
                            <br/> Quarter: <%=request.getParameter("QUARTER")%> <%=request.getParameter("YEAR")%></th>
                    </tr>
                    <tr>
                    <th>Grade Count </th>
                    <th>Grade </th>
                    ...
                    <tr>
                        ...
                        <td>
                            <%=resset1.getString("LETTER_GRADE")%>
                        </td>
                    </tr>
                    <%
                        }
    ...
    <form action="decisionsupportii.jsp" method="POST">
         ...
         <table border="1">
                    ...
                    <tr>
                        <form action="decisionsupportii.jsp" method="get">

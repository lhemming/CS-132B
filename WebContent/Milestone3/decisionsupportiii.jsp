...
<body>
    ...
    <form action="decisionsupportiii.jsp" method="POST">
         ...
         <table border="1">
                    ...
                    <tr>
                        <form action="decisionsupportiii.jsp" method="get">

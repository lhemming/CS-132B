...
<body>
        ...
        <tr>
            ...
            <%
                ...
                if (action != null && action.equals("submit")) {
                    ...
                    <table border="1">
                    <tr>
                        <th>Displaying Avg GPA For Course: <%=request.getParameter("CLASSID")%> 
                            <br/>
    ...
    <form action="decisionsupportv.jsp" method="POST">
         ...
         <table border="1">
                    ...
                    <tr>
                        <form action="decisionsupportv.jsp" method="get">

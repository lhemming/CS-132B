        ...
        <tr>
            ...
            <%
                ...
                if (action != null && action.equals("submit")) {
                    ...
                    PreparedStatement pstmt = conn.prepareStatement("SELECT pastclasses.courseid, class.name, pastclasses.quarter, pastclasses.year, pastclasses.units, pastclasses.grade FROM student s, class, pastclasses, grade_conversion g WHERE s.ssn = ? AND  s.studentid = pastclasses.studentid AND class.classid = pastclasses.courseid AND pastclasses.year = class.year AND pastclasses.quarter = class.quarter AND pastclasses.grade = g.letter_grade ORDER BY pastclasses.quarter, pastclasses.year ");

                    pstmt.setInt(1, Integer.parseInt(request.getParameter("SSN_returned")));
                    resset1 = pstmt.executeQuery();

                     PreparedStatement pstmt1 = conn.prepareStatement("SELECT pastclasses.quarter, pastclasses.year, avg(number_grade) AS avg_grade FROM student s, class, pastclasses, grade_conversion g WHERE s.ssn = ? AND  s.studentid = pastclasses.studentid AND class.classid = pastclasses.courseid AND pastclasses.grade = g.letter_grade AND pastclasses.year = class.year AND pastclasses.quarter = class.quarter GROUP BY pastclasses.quarter, pastclasses.year ");
                    ...
                    <tr>
                        ...
                        <td>
                            <%=resset1.getString("QUARTER")%> <%=resset1.getString("YEAR")%>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <%=resset2.getString("QUARTER")%> <%=resset2.getString("YEAR")%>
                        </td>
                        <td>

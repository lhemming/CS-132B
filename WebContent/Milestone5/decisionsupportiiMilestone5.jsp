...
<body>
        ...
        <tr>
            ...
            <%
                ...
                if (action != null && action.equals("submit")) {
                    ...
                    //error here rn
                    PreparedStatement pstmt = conn.prepareStatement("SELECT gradecount AS COUNT, grade FROM cpqg WHERE cpqg.classid = ? AND cpqg.instructor = ? AND cpqg.quarter = ? AND cpqg.year = ? ORDER BY grade");
    ...
    <form action="decisionsupportiiMilestone5.jsp" method="POST">
         ...
         <table border="1">
                    ...
                    <tr>
                        <form action="decisionsupportiiMilestone5.jsp" method="get">

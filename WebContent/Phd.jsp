        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt2.setString(3, request.getParameter("CANDIDACY"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                       ...
                       PreparedStatement pstmt = conn.prepareStatement(
                        ...
                        PreparedStatement pstmt2 = conn.prepareStatement(
                            "UPDATE Phd SET UNITS = ?, CANDIDACY = ? " +
                            "WHERE STUDENTID = ?");

                        pstmt2.setInt(
                            1, Integer.parseInt(request.getParameter("UNITS")));
                        pstmt2.setString(2, request.getParameter("CANDIDACY"));
            ...
            <%
                    ...
                    ResultSet rs = statement.executeQuery
                        ("SELECT * FROM Phd,Student WHERE Phd.studentid = Student.studentid");
            %>

        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt2 = conn.prepareStatement(
                            "INSERT INTO GraduateMS VALUES (?, ?, ?)"); //" ?, ?)");

                        pstmt2.setString(1, request.getParameter("STUDENTID"));
                        pstmt2.setInt(2, Integer.parseInt(request.getParameter("UNITS")));
                        pstmt2.setString(3, request.getParameter("DEPARTMENT"));
                        int rowCount2 = pstmt2.executeUpdate();

                        PreparedStatement pstmt3 = conn.prepareStatement(
                            "INSERT INTO Undergrad VALUES (?, ?, ?, ?, ?, ?)"); //" ?, ?)");

                        pstmt3.setString(1, request.getParameter("STUDENTID"));
                        pstmt3.setString(2,request.getParameter("MAJOR"));
                        pstmt3.setString(3,request.getParameter("MINOR"));
                        pstmt3.setString(4, request.getParameter("COLLEGE"));
                        pstmt3.setInt(5, Integer.parseInt(request.getParameter("UNITS")));
                        pstmt3.setString(6, request.getParameter("YEAR"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        pstmt3.setString(1, request.getParameter("MAJOR"));
                        pstmt3.setString(2, request.getParameter("MINOR"));
                        pstmt3.setString(3, request.getParameter("COLLEGE"));
                        pstmt3.setInt(
                            4, Integer.parseInt(request.getParameter("UNITS")));
                        pstmt3.setString(5, request.getParameter("YEAR"));
                        pstmt3.setString(6, request.getParameter("STUDENTID"));
                        int rowCount3 = pstmt3.executeUpdate();
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        //PreparedStatement pstmt2 = conn.prepareStatement(
                          //  "DELETE FROM GraduateMS WHERE STUDENTID = ?");
            ...
            <%
                    ...
                    ResultSet rs = statement.executeQuery
                        ("SELECT * FROM GraduateMS, Student, Undergrad");
            %>
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="UndergradBSMS.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th>SSN</th><br>
                            <th><input value="" name="SSN" size="10"></th><br>

...
*/
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Enrolled SET SECTIONID = ?, UNITS = ?, GRADETYPE = ?, QUARTER = ?, YEAR = ? WHERE STUDENTID = ? AND COURSEID = ?");
            ...
            <%
                    ...
                    if(sqle.getErrorCode() == 52000) {
                    %>
                    To add to student to waitlist, click <a href="waitlist.jsp">here<a>
                    <%
                    }
                } catch (Exception e) {

        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setString(1, request.getParameter("FACULTYID"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Faculty SET NAME = ?, TITLE = ?, DEPARTMENT = ? WHERE FACULTYID = ?");

                        pstmt.setString(1, request.getParameter("NAME"));
                        pstmt.setString(2, request.getParameter("TITLE"));
                        pstmt.setString(3, request.getParameter("DEPARTMENT"));
                        pstmt.setString(4, request.getParameter("FACULTYID"));
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="faculty.jsp" method="get">
                            ...
                            <th><input value="" name="FACULTYID" size="10"></th>
                            <th><input value="" name="NAME" size="50"></th>
                            <th><input value="" name="TITLE" size="25"></th>
            ...
            %>
                    ...
                    <tr>
                        <form action="faculty.jsp" method="get">
                            ...
                            <td>
                                <input value="<%= rs.getString("FACULTYID") %>" 
                                    name="FACULTYID" size="10">
                            </td>

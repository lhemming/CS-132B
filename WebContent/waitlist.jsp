...
*/
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE Waitlisted SET SECTIONID = ?, UNITS = ?, GRADETYPE = ? WHERE STUDENTID = ? AND COURSEID = ?");
                        ...
                        pstmt.setString(5, request.getParameter("COURSEID"));
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM Waitlisted WHERE STUDENTID = ? AND COURSEID = ?");
